                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-default pull-left" data-bs-dismiss="modal"><span class="glyphicon glyphicon-remove" onclick="addUser()"></span> Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
